...
export default function Footer() {
  return (
    <footer className="bg-surface border-t border-chip mt-20">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Contact */}
          <div>
            <h3 className="font-bold text-ink mb-4">تواصل معنا</h3>
            <div className="space-y-3">
              <a href="https://wa.me/966508949041" target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-3 min-h-11 text-muted hover:text-green-600 transition-colors text-sm group">
                <div className="w-8 h-8 rounded-lg bg-green-600/10 border border-green-600/30 flex items-center justify-center group-hover:bg-green-600/20 transition-all">
              ...
              <a href="https://ig.me/m/Billy_Store3" target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-3 min-h-11 text-muted hover:text-pink-600 transition-colors text-sm group">
                <div className="w-8 h-8 rounded-lg bg-pink-600/10 border border-pink-600/30 flex items-center justify-center group-hover:bg-pink-600/20 transition-all">
              ...
              <a href="https://t.me/BillyStore1" target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-3 min-h-11 text-muted hover:text-blue-600 transition-colors text-sm group">
                <div className="w-8 h-8 rounded-lg bg-blue-500/10 border border-blue-500/30 flex items-center justify-center group-hover:bg-blue-500/20 transition-all">
                  <svg className="w-4 h-4 text-blue-600" fill="currentColor" viewBox="0 0 24 24"><path d="M9.78 18.65l.28-4.23 7.68-6.92c.34-.31-.07-.46-.52-.19L7.74 13.3 3.64 12c-.88-.25-.89-.86.2-1.3l15.97-6.16c.73-.33 1.43.18 1.15 1.3l-2.72 12.81c-.19.91-.74 1.13-1.5.71L12.6 16.3l-1.99 1.93c-.23.23-.42.42-.83.42z"/></svg>
                </div>
                @BillyStore1
              </a>
            </div>
        ...
        <div className="border-t border-chip mt-8 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-muted text-sm">© 2026 Billy Store. جميع الحقوق محفوظة.</p>
          <div className="flex items-center gap-2">
            <PsGlyphField variant="mark" />
