          ...
          <div>
            ...
            <div className="space-y-3">
              <a href="https://wa.me/966508949041" target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-3 text-muted hover:text-green-600 transition-colors text-sm group">
              ...
              <a href="https://ig.me/m/Billy_Store3" target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-3 text-muted hover:text-pink-600 transition-colors text-sm group">
              ...
              <a href="https://t.me/BillyStore1" target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-3 text-muted hover:text-blue-600 transition-colors text-sm group">
